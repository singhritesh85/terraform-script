...
#  availability_zones = var.Availabilty_Zone  # ["${var.Availabilty_Zone[0]}", "${var.Availabilty_Zone[1]}", "${var.Availabilty_Zone[2]}"]
  subnets = var.subnet  #  ["subnet-5d85d427", "subnet-e116afad", "subnet-ea2f3482"]
