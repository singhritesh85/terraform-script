...
#}
variable "subnet" {
description = "Provide the VPC Subnet into which the Loadbalancer will be created"
type = list
default = ["subnet-070ec2c4ff53f26c8", "subnet-08b5ed4d9ab6d5894"]
}
variable "security_groups" {
description = "Provide the security group Id gor the classic load balancer"
type = list
...
type = list
default = ["i-08f8261e7aa21a9c8", "i-05eb4a3163fef01d6"]
}
