variable "region" {
description = "Provide the AWS Region into which the lambda function to be created"
type = string
default = "us-east-2"
}
...
type = string
default = "/root/create_lambda_using_module/module/policy.json"
}
variable "trust-advisor" {
description = "Provide the trust advisor in json for lambda function IAM Role"
type = string
default = "/root/create_lambda_using_module/module/trust-advisor.json"
}
variable "filename" {
