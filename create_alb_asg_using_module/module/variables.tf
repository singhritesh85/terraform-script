...
type = string
default = "arn:aws:acm:us-east-2:562086155953:certificate/cda8d388-ccb0-4e0c-8d5c-61024652b170" ###  "arn:aws:acm:us-east-2:562086155953:certificate/6c5f1f64-d2b7-4680-8133-4c2623f58d55"
}
variable "http_type" {
